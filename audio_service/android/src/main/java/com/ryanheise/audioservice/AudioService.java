...
public class AudioService extends MediaBrowserServiceCompat {
	...
	public void onLoadChildren(final String parentMediaId, final Result<List<MediaBrowserCompat.MediaItem>> result) {
		if (listener == null) {
			...
			if (parentMediaId != null && parentMediaId.startsWith("__")) {
				Intent intent = getPackageManager().getLaunchIntentForPackage("s.s.saturn");
	...
	public class MediaSessionCallback extends MediaSessionCompat.Callback {
		...
		public void onPlay() {
			if (listener == null) return;
			listener.onPlay();
			System.err.println("onPlay Called");
		}
		...
		public boolean onMediaButtonEvent(Intent mediaButtonEvent) {
			...
			if (event.getAction() == KeyEvent.ACTION_DOWN) {
				...
				System.err.println("BYPASSPLAY");
					onPlay();
					break;
				case KEYCODE_BYPASS_PAUSE:
				System.err.println("BYPASSPAUSE");
					onPause();
					break;
				...
				case KeyEvent.KEYCODE_MEDIA_NEXT: System.err.println("NEXT");
				case KeyEvent.KEYCODE_MEDIA_PREVIOUS: System.err.println("PREVIOUS");
				case KeyEvent.KEYCODE_MEDIA_PLAY: System.err.println("PLAY");
				case KeyEvent.KEYCODE_MEDIA_PAUSE: System.err.println("PAUSE");
					// These are the "genuine" media button click events
				case KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE: System.err.println("PLAYPAUSE");
		...
		public void onSkipToNext() {
			...
			System.err.println("onSkipToNext Called");
		}
		...
		public void onSkipToPrevious() {
			...
			System.err.println("onSkipToPrevious Called");
		}
		...
		public void onSeekTo(long pos) {
			...
			System.err.println("onSeekTo Called");
		}
		...
		public void onSetRating(RatingCompat rating) {
			...
			System.err.println("onSetRating Called");
		}
